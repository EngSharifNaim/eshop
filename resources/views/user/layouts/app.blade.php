...
<div class="navbar navbar-expand-md navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link dropdown-toggle caret-0" data-toggle="dropdown">
                    ...
                    {{$category->name}}
                    <span class="d-md-none ml-2">Host Types</span>
                </a>

                <div class="dropdown-menu dropdown-content wmin-md-350">
                    <div class="dropdown-content-header">
                        <span class="font-weight-semibold">{{$category->name}} Types</span>
                        <a href="#" class="text-default"><i class="icon-server"></i></a>
                    </div>
                        ...
                        <ul class="media-list">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <a href="{{url('user/show_products/' . $subcategory->id)}}">
                                        {{$subcategory->name}}
                                    </a>

                                    <div class="text-muted font-size-sm">There is {{count($subcategory->Product)}} products</div>
                                </div>
                            </li>
                                @endforeach
                        </ul>
        ...
        <span class="btn btn-outline-success ml-md-3 mr-md-auto">Amount: {{Auth::User()->amount}} <i class="icon-price-tag"></i> </span>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
                    <img src="{{url('images/user.png')}}" class="rounded-circle mr-2" height="34" alt="">
                    @if(Auth::check())
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="{{url('user/orders/')}}" class="dropdown-item"><i class="icon-list2"></i> My Orders</a>
                    <a href="{{url('user/reports/')}}" class="dropdown-item"><i class="icon-comments"></i> Reports <span class="badge badge-pill bg-blue ml-auto">
{{--                            {{count($reports)}}--}}
                        </span></a>
                    <a href="{{url('user/tickets/')}}" class="dropdown-item"><i class="icon-comment-discussion"></i> Tickets <span class="badge badge-pill bg-blue ml-auto">
{{--                            {{count($tickets)}}--}}
                        </span></a>
        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - {{$category->name}}</h4>
