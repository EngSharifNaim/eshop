                    ...
                    @if(count($reports) == 0)
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Empty Report List</h5>
                                <p class="mb-3">There is no reports in this category products orders</p>

                                <a href="{{url('seller/reports')}}" class="btn bg-danger-400">Go to all reports list <i class="icon-arrow-right14 ml-2"></i></a>
                            </div>
                        </div>
                    @endif
                    </tbody>
