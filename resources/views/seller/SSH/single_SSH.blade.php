    ...
    <div class="datatable-scroll">
        <table class="table datatable-basic dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
            ...
            <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="DOB: activate to sort column ascending">WHM</th>
            ...
            @foreach($single_products as $product)
                ...
                @include('seller.modals.edit_ssh')
            @endforeach
            </tbody>
        </table>
    </div>
