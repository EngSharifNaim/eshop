<div id="modal_theme_info_EmailMarketing" class="modal fade"  style="padding-right: 15px;">
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" id="add_marketing_domain" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
...
<script>
    $('#add_marketing_domain').on('submit', function(event){
