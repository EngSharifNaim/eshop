<div id="modal_theme_info_Combo" class="modal fade"  style="padding-right: 15px;">
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" id="add_combo_marketing" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
...
<script>
    $('#add_combo_marketing').on('submit', function(event){
