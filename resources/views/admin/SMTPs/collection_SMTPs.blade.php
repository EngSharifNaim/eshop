    ...
    <div class="datatable-scroll">
        <table class="table datatable-basic dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
            ...
            <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Last Name: activate to sort column ascending">collection_details</th>
            ...
            @foreach($collection_products as $product)
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal_theme_info_edit{{$subcategory->name . '_' . $product->id}}_collection"><i class="icon-database-edit2"></i> Edit Product</a>
                                </div>
                            </div>
                        </div>
                    </td>
                ...
                @include('seller.modals.edit_rdp_collection')
