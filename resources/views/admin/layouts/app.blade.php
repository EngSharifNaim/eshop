        ...
        <div class="sidebar-content">
            ...
            <div class="card card-sidebar-mobile">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"><i class="icon-users2"></i> <span>Users Rules</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/users')}}" class="nav-link  @if(\Request::route()->getName() == 'admin.users')active @endif"><i class="icon-users4 @if(\Request::route()->getName() == 'admin.users') text-light @else text-teal-300 @endif"></i> <span>Users</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('admin/sellers')}}" class="nav-link  @if(\Request::route()->getName() == 'admin.sellers')active @endif"><i class="icon-users @if(\Request::route()->getName() == 'admin.sellers') text-light @else text-teal-300 @endif"></i> <span>Sellers</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('admin/admins')}}" class="nav-link  @if(\Request::route()->getName() == 'admin.admins')active @endif"><i class="icon-users @if(\Request::route()->getName() == 'admin.admins') text-light @else text-teal-300 @endif"></i> <span>Admins</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"><i class="icon-task"></i> <span>Actions</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/orders')}}" class="nav-link  @if(\Request::route()->getName() == 'admin.allOrders')active @endif"><i class="icon-list-ordered @if(\Request::route()->getName() == 'admin.allOrders') text-light @else text-teal-300 @endif"></i> <span>Sales</span></a>
                    </li>
                    <li class="nav-item ">
                        <a href="{{url('admin/withdraw')}}" class="nav-link @if(\Request::route()->getName() == 'admin.withdraw')active @endif"><i class="icon-price-tag @if(\Request::route()->getName() == 'admin.withdraw') text-light @else text-teal-300 @endif"></i> <span>Withdraw</span></a>

                    </li>
                    <li class="nav-item ">
                        <a href="{{url('admin/reports')}}" class="nav-link @if(\Request::route()->getName() == 'admin.reports')active @endif"><i class="icon-list @if(\Request::route()->getName() == 'admin.reports') text-light @else text-teal-300 @endif"></i> <span>Reports</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Starter kit">
                            @foreach($category->SubCategory as $sub)
                                <li class="nav-item"><a href="{{url('admin/SubCategory/' . $sub->id)}}" class="nav-link">{{$sub->name}}</a></li>
                                @endforeach
                        </ul>
                    </li>
                    @endforeach
