<div id="modal_theme_info_editSSH_{{$product->id}}" class="modal fade"  style="padding-right: 15px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <br>
                    <div class="card-body">
                        <form action="#" id="edit_ssh" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-float">
                                        <div class="input-group">
                                            ...
                                            <select name="whm" class="form-control" placeholder="Country ...">
                                                <option value="0">WHM</option>
                                                <option value="Yes" @if($product->whm == 'Yes') selected @endif>Yes</option>
                                                <option value="No" @if($product->whm == 'No') selected @endif>No</option>
                                            </select>
...
<script>
    $('#edit_ssh').on('submit', function(event){
