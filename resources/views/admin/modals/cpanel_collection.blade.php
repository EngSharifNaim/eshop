<div id="modal_theme_info_CPanel_collection" class="modal fade"  style="padding-right: 15px;">
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" id="add_cpanel_collection" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
...
<script>
    $('#add_cpanel_collection').on('submit', function(event){
